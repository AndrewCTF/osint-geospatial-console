...
> **Brand:** Velocity — projectvelocity.org · **License:** Apache-2.0

## Shipped this pass (2026-06-16)

- ✅ Named **Velocity** (README title, `index.html`, showcase line).
- ✅ **Apache-2.0** `LICENSE` + `NOTICE` (per-upstream attribution incl. NC feeds).
...
- [x] **LICENSE + NOTICE shipped.** Apache-2.0 + per-upstream attribution; `license`
