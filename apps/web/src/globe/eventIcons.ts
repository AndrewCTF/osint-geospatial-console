...
function blastSvg(color: string): string {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
    <path d="M12 1 L13.7 7.2 L18.5 3.2 L16.4 9 L22.8 8.2 L17.6 12 L22.8 15.8 L16.4 15 L18.5 20.8 L13.7 16.8 L12 23 L10.3 16.8 L5.5 20.8 L7.6 15 L1.2 15.8 L6.4 12 L1.2 8.2 L7.6 9 L5.5 3.2 L10.3 7.2 Z"
      fill="${color}" stroke="${OUT}" stroke-width="0.7" stroke-linejoin="round"/>
  </svg>`;
}
...
function airstrikeSvg(color: string): string {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20">
    <path d="M12 21.5 C8.4 21.5 6.8 18.3 6.8 15 C6.8 10.8 9.8 7.6 12 3.5 C14.2 7.6 17.2 10.8 17.2 15 C17.2 18.3 15.6 21.5 12 21.5 Z"
      fill="${color}" stroke="${OUT}" stroke-width="0.75" stroke-linejoin="round"/>
    <rect x="11.1" y="1.4" width="1.8" height="3.4" rx="0.6" fill="${color}" stroke="${OUT}" stroke-width="0.4"/>
    <path d="M8.6 2.6 L12 5.6 L15.4 2.6" fill="none" stroke="${color}" stroke-width="1.3" stroke-linejoin="round"/>
  </svg>`;
}
...
function artillerySvg(color: string): string {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="22" height="22">
    <path d="M3 20 Q11 1 21 11" fill="none" stroke="${color}" stroke-width="1.4" stroke-linecap="round" stroke-dasharray="1.6 2"/>
    <path d="M18.4 8.4 L22.6 10.8 L18.8 13.4 Z" fill="${color}" stroke="${OUT}" stroke-width="0.5" stroke-linejoin="round"/>
    <path d="M3 20 l2.6 -1 l-1 2.6 z" fill="${color}" stroke="${OUT}" stroke-width="0.4"/>
  </svg>`;
}
...
function clashSvg(color: string): string {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="22" height="22">
    <path d="M4 3 L14 15 L12.5 16.5 L2.5 4.5 Z" fill="${color}" stroke="${OUT}" stroke-width="0.6" stroke-linejoin="round"/>
    <path d="M20 3 L10 15 L11.5 16.5 L21.5 4.5 Z" fill="${color}" stroke="${OUT}" stroke-width="0.6" stroke-linejoin="round"/>
    <circle cx="4" cy="19" r="2" fill="${color}" stroke="${OUT}" stroke-width="0.5"/>
    <circle cx="20" cy="19" r="2" fill="${color}" stroke="${OUT}" stroke-width="0.5"/>
  </svg>`;
}
...
function gunfireSvg(color: string): string {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20">
    <circle cx="12" cy="12" r="7.5" fill="none" stroke="${color}" stroke-width="1.6"/>
    <circle cx="12" cy="12" r="2.2" fill="${color}" stroke="${OUT}" stroke-width="0.4"/>
    <line x1="12" y1="1.5" x2="12" y2="5.5" stroke="${color}" stroke-width="1.6"/>
    <line x1="12" y1="18.5" x2="12" y2="22.5" stroke="${color}" stroke-width="1.6"/>
    <line x1="1.5" y1="12" x2="5.5" y2="12" stroke="${color}" stroke-width="1.6"/>
    <line x1="18.5" y1="12" x2="22.5" y2="12" stroke="${color}" stroke-width="1.6"/>
  </svg>`;
}
...
function droneSvg(color: string): string {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20">
    ...
    <rect x="9.5" y="9.5" width="5" height="5" rx="1" fill="${color}" stroke="${OUT}" stroke-width="0.5"/>
  </svg>`;
}
...
function navalSvg(color: string): string {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="22" height="22">
    <path d="M3 13 L21 13 L18 19 L6 19 Z" fill="${color}" stroke="${OUT}" stroke-width="0.7" stroke-linejoin="round"/>
    <rect x="10" y="8" width="4" height="5" fill="${color}" stroke="${OUT}" stroke-width="0.5"/>
    <path d="M15.5 3 L16.6 6 L19.5 6 L17.2 7.9 L18.1 11 L15.5 9.2 L12.9 11 L13.8 7.9 L11.5 6 L14.4 6 Z"
      fill="${color}" stroke="${OUT}" stroke-width="0.4" stroke-linejoin="round"/>
  </svg>`;
}
